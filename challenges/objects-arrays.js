...
*/
const displayNames = [];
zooAnimals.forEach(object => displayNames.push(`Name: ${object.animal_name}, Scientific: ${object.scientific_name}`) );
...
const lowCaseAnimalNames = zooAnimals.map(object => object.animal_name.toLowerCase());
...
const lowPopulationAnimals = zooAnimals.filter(object => object.population < 5);
...
const populationTotal = zooAnimals.reduce((total, animal) => total + animals.population, 0 );
